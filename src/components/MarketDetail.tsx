          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-6 ml-8">
                <div>
                  <p className="text-2xl font-bold text-gray-900">${market.last_price.toFixed(2)}</p>
                  <p className={`text-sm ${isPositive ? 'text-green-600' : 'text-red-600'}`}>
                    {isPositive ? '+' : ''}{market.twenty_four_hour_change.toFixed(2)}% (24h)
                  </p>
                </div>
                <div className="text-sm text-gray-500">
                  <p>Funding Rate</p>
                  <p className="font-medium text-gray-900">{market.funding_rate.toFixed(4)}%</p>
                </div>
                <div className="text-sm text-gray-500">
                  <p>24h Volume</p>
                  <p className="font-medium text-gray-900">${market.twenty_four_hour_vol.toLocaleString()}</p>
                </div>
                <div className="text-sm text-gray-500">
                ...
                <div className="text-sm text-gray-500">
                  ...
                  <p className="font-medium text-gray-900">5 min 23 sec</p>
                </div>
              </div>
            </div>
